...
function rbfresh_scripts() {
    ...
    // Load compiled main.css
    wp_enqueue_style('rbfresh-main', get_template_directory_uri() . '/assets/css/main.css', array(), filemtime(get_template_directory() . '/assets/css/main.css'));
